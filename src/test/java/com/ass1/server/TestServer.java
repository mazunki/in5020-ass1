...
public class TestServer {
	public static void main(String[] args) {
		try {
			...
			ServerStub server = new ServerStub("test", "test");
			...
			int expectedNumberOfCountries = 7; // Expecting 7 countries with at least 2 cities having
			...
			// Test 4: getNumberofCountries (cityCount = 30, population between 100,000 and
			// 800,000)
			System.out.println(
			...
			expectedNumberOfCountries = 30; // Expecting 30 countries with at least 30 cities having
							// population between 100,000 and 800,000
			System.out.println("Expected Number of Countries: " + expectedNumberOfCountries);
			System.out.println("Actual Number of Countries: " + numberOfCountries);
			System.out.println("Test Passed: " + (numberOfCountries == expectedNumberOfCountries));
